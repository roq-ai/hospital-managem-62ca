  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless operations with Hospital Management - integrating patient records, billing, medication, and test reports. Manage appointments and track doctor availability efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob3NwaXRhbHxlbnwwfHx8fDE2OTQxMDA1Njd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@marceloleal80?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Marcelo Leal`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless operations with Hospital Management - integrating patient records, billing, medication, and test reports. Manage appointments and track doctor availability efficiently.`}
            </Text>
            <Box
