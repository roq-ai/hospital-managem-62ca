...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    roles: ['system-administrator', 'doctor', 'pharmacist', 'nurse'],
    key: 'doctor-availability-update',
    tenantPath: ['hospital', 'user'],
    userPath: [],
  },
  'patient.create': {
    roles: ['system-administrator', 'doctor', 'pharmacist', 'nurse'],
    key: 'new-patient-record',
    tenantPath: ['hospital', 'patient'],
    userPath: [],
  },
  'medicine.update': {
    roles: ['system-administrator', 'doctor', 'pharmacist', 'nurse'],
    key: 'medicine-stock-update',
    tenantPath: ['hospital', 'medicine'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['system-administrator', 'doctor', 'pharmacist', 'nurse'],
    key: 'new-appointment',
    tenantPath: ['hospital', 'appointment'],
    userPath: [],
  },
  'test_report.update': {
    roles: ['system-administrator', 'doctor', 'pharmacist', 'nurse'],
    key: 'test-report-update',
    tenantPath: ['hospital', 'test_report'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['system-administrator', 'doctor', 'pharmacist', 'nurse'];
